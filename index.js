...
window.addEventListener("load", function(event) {
  ...
  var projectText = (e) => {
    ...
    switch (projectId) {
      case 'circle1':
        project = document.querySelector("#codepen");
        break;
      case 'circle2':
        project = document.querySelector("#github");
        break;
      case 'circle3':
        project = document.querySelector("#arcade");
        break;
      case 'circle4':
        project = document.querySelector("#sailing");
        break;
      default:
    }
  ...
  if (innerWidth < 800) {
    circle.on("touchstart", function(e) {
      if (hoverOpen) {
        ...
        clicked = e.target.id;
        if (hoverOpen) {
          $(".projection").on("touchstart touchend", function() {
            openLinks(clicked);
          });
